...
function LandingPage() {
  return (
    <div className="h-screen overflow-y-auto scroll-smooth snap-y snap-mandatory">
      ...
      <LazySection className="snap-start snap-always h-screen event-section-bg text-white">
        <AboutCoRE />
      </LazySection>

      {/* Section 3 - Rules (Round 1) (Lazy load when scrolling) */}
      <LazySection className="snap-start snap-always h-screen event-section-bg">
        <Rules />
      </LazySection>
